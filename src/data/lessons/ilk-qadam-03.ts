...
export const lesson03Quiz: QuizQuestion[] = [
  {
    ...
    options: [
      ...
      { id: "o3", label: "Aylana bo‘ylab bir xil tezlikda aylanish", isCorrect: false },
      { id: "o4", label: "Faqat birinchi sekundda tez yuradigan harakat", isCorrect: false },
    ],
  },
  {
    id: "ilk-03-q2",
    position: 2,
    question: "Avtomobil $36\\text{ km/soat}$ tezlik bilan ketmoqda. Bu tezlik SI birligida ($\\text{m/s}$) nechaga teng?",
    explanation: "$36\\text{ km/soat}$ ni $3.6$ ga bo‘lsak: $36 / 3.6 = 10\\text{ m/s}$ bo‘ladi.",
    options: [
      { id: "o1", label: "10 m/s", isCorrect: true },
      { id: "o2", label: "36 m/s", isCorrect: false },
      { id: "o3", label: "3.6 m/s", isCorrect: false },
      { id: "o4", label: "100 m/s", isCorrect: false },
    ],
  },
  {
    id: "ilk-03-q3",
    position: 3,
    question: "Jism $5\\text{ m/s}$ doimiy tezlik bilan $4\\text{ sekund}$ harakatlandi. Jism qancha masofa bosib o‘tgan?",
    explanation: "Yo‘l formulasi: $s = v \\times t = 5\\text{ m/s} \\times 4\\text{ s} = 20\\text{ m}$.",
    options: [
      { id: "o1", label: "20 m", isCorrect: true },
      { id: "o2", label: "9 m", isCorrect: false },
      { id: "o3", label: "1.25 m", isCorrect: false },
      { id: "o4", label: "25 m", isCorrect: false },
    ],
  },
  {
    id: "ilk-03-q4",
    position: 4,
    question: "Poyezd $120\\text{ km}$ masofani $2\\text{ soat}$da bosib o‘tdi. Poyezdning o‘rtacha tezligi qanday?",
    explanation: "O‘rtacha tezlik: $v_{\\text{o‘rt}} = s / t = 120 / 2 = 60\\text{ km/soat}$.",
    options: [
      { id: "o1", label: "60 km/soat", isCorrect: true },
      { id: "o2", label: "120 km/soat", isCorrect: false },
      { id: "o3", label: "240 km/soat", isCorrect: false },
      { id: "o4", label: "30 km/soat", isCorrect: false },
    ],
  },
  {
    id: "ilk-03-q5",
    position: 5,
    question: "Nima sababdan o‘rtacha tezlikni shunchaki tezliklar yig‘indisining yarmi ($(v_1 + v_2)/2$) deb hisoblab bo‘lmaydi?",
    explanation: "Chunki jism har xil tezliklarda har xil vaqt harakatlangan bo‘lishi mumkin. O‘rtacha tezlik faqat jami yo‘lni jami vaqtga bo‘lish orqali topiladi.",
    options: [
      { id: "o1", label: "Chunki har xil tezlikdagi harakatga har xil vaqt sarflanadi", isCorrect: true },
      { id: "o2", label: "Chunki tezliklarni qo‘shish taqiqlangan", isCorrect: false },
      { id: "o3", label: "Chunki spidometr faqat bitta sonni ko‘rsatadi", isCorrect: false },
      { id: "o4", label: "Chunki yo‘l har doim nolga teng bo‘ladi", isCorrect: false },
    ],
  },
];
...
export const lesson03Practice: PracticeTask[] = [
  {
    id: "ilk-03-p1",
    position: 1,
    prompt: "Velosipedchi $6\\text{ m/s}$ doimiy tezlik bilan $15\\text{ sekund}$ harakatlandi. Velosipedchi bosib o‘tgan masofani ($\\text{m}$) hisoblang.",
    unit: "m",
    answer: 90,
    tolerance: 0.1,
    hint: "$s = v \\times t = 6 \\times 15$.",
    solution: "$s = 6\\text{ m/s} \\times 15\\text{ s} = 90\\text{ m}$.",
  },
  {
    id: "ilk-03-p2",
    position: 2,
    prompt: "Piyoda $300\\text{ metr}$ masofani $50\\text{ sekund}$da bosib o‘tdi. Piyodaning tezligini ($\\text{m/s}$) toping.",
    unit: "m/s",
    answer: 6,
    tolerance: 0.1,
    hint: "$v = s / t = 300 / 50$.",
    solution: "$v = \\frac{300\\text{ m}}{50\\text{ s}} = 6\\text{ m/s}$.",
  },
  {
    id: "ilk-03-p3",
    position: 3,
    prompt: "Avtomobil $90\\text{ km/soat}$ tezlik bilan ketmoqda. Avtomobilning tezligini $\\text{m/s}$ larda ifodalang.",
    unit: "m/s",
    answer: 25,
    tolerance: 0.1,
    hint: "$\\text{km/soat}$ dan $\\text{m/s}$ ga o‘tish uchun $3.6$ ga bo‘ling ($90 / 3.6$).",
    solution: "$v = \\frac{90}{3.6} = 25\\text{ m/s}$.",
  },
  {
    id: "ilk-03-p4",
    position: 4,
    prompt: "Samolyot $200\\text{ m/s}$ doimiy tezlik bilan $30\\text{ sekund}$ uchdi. Samolyot necha kilometr ($\\text{km}$) masofani bosib o‘tgan?",
    unit: "km",
    answer: 6,
    tolerance: 0.1,
    hint: "$s = 200 \\times 30 = 6000\\text{ m}$. Kilometrga o‘tish uchun $1000$ ga bo‘ling.",
    solution: "$s = 200\\text{ m/s} \\times 30\\text{ s} = 6000\\text{ m} = 6\\text{ km}$.",
  },
  {
    id: "ilk-03-p5",
    position: 5,
    prompt: "Sayyoh 1-soatda $4\\text{ km}$, keyingi 2 soatda $8\\text{ km}$ yurdi. Sayyohning butun yo‘ldagi o‘rtacha tezligini ($\\text{km/soat}$) toping.",
    unit: "km/h",
    answer: 4,
    tolerance: 0.1,
    hint: "Jami yo‘l $4 + 8 = 12\\text{ km}$, jami vaqt $1 + 2 = 3\\text{ soat}$. $v_{\\text{o‘rt}} = 12 / 3$.",
    solution: "$v_{\\text{o‘rt}} = \\frac{4 + 8}{1 + 2} = \\frac{12}{3} = 4\\text{ km/soat}$.",
  },
];
