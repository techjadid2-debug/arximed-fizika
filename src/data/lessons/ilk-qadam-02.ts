...
export const lesson02Quiz: QuizQuestion[] = [
  {
    id: "ilk-02-q1",
    position: 1,
    question: "O‘quvchi ertalab uydan maktabga 500 m bordi va yana uyiga qaytib keldi. Uning ko‘chishi nimaga teng?",
    explanation: "Ko‘chish — boshlang‘ich va oxirgi nuqta orasidagi yo‘nalgan kesma. Boshlagan joyiga qaytib kelgani uchun ko‘chish 0 m bo‘ladi (yo‘l esa 1000 m).",
    options: [
...
export const lesson02Practice: PracticeTask[] = [
  {
    ...
    position: 1,
    prompt:
      "Motorli qayiqning tinch suvdagi tezligi $12\\text{ m/s}$, daryo oqimining tezligi esa $3\\text{ m/s}$. Qayiq oqim bo‘ylab harakatlanganda uning qirg‘oqqa nisbatan tezligini ($\\text{m/s}$) hisoblang.",
    unit: "m/s",
    answer: 15,
    tolerance: 0.1,
    hint: "Oqim bo‘ylab harakatda tezliklar qo‘shiladi: $v_{\\text{nat}} = v_{\\text{qayiq}} + v_{\\text{oqim}}$.",
    solution:
      "**Namunaviy yechim:**\n- **Berilgan:** $v_{\\text{qayiq}} = 12\\text{ m/s}$, $v_{\\text{oqim}} = 3\\text{ m/s}$\n- **Topish kerak:** $v_{\\text{nat}} - ?$\n- **Formula:** $v_{\\text{nat}} = v_{\\text{qayiq}} + v_{\\text{oqim}}$\n- **Yechilishi:** $v_{\\text{nat}} = 12\\text{ m/s} + 3\\text{ m/s} = 15\\text{ m/s}$\n- **Javob:** $15\\text{ m/s}$.",
  },
];
